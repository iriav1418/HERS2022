...
library(growthcurver) # analyze bacterial growth curves
library(drc) # analyzes dose response curves to calcualte ED50
...
## Rhizobial ED50 calculation
```{r}
#### This chunk examines rhizobial growth curves that were produced from a functional test of the response of various rhizobial strains to dicamba (i.e. a test of dicamba tolerance). In this test, rhizobia were grown in the presence of different dicamba concentrations on a 96 well-plate for 48 hours and their growth (indicated by OD600) was automatically recorded by a plate reader every 30 min.

### Plate 1

dat1 <- read.csv("HERS2022_GrowthCurves_TolScreen1_data_11-20-22v2.csv") # load data from first 96-well plate
dat <- data.frame(matrix(NA,    # Create empty data frame
                          nrow = 97,
                          ncol = 97))

column_names <- colnames(dat1)
colnames(dat) <- column_names
dat$Hours <- dat1$Hours

## Create new data frame with blanked data. At each time point, OD600 readings of treatment wells were subtracted by the mean OD600 readings of blank and uninoculated wells
for(i in 1:97){
  for(j in 2:97){
   dat[i,j] <- dat1[i,j] - rowMeans(dat1[i, c(57:61, 67:68, 79:80, 91:92)])
   j <- j + 1
  }
  i <- i + 1
}

dat2 <- gather(dat, key = "Well_ID", value = "OD600", 2:97)

dat2$strain <- "A"
dat2$dicamba_concentration <- 0.00

## Assign strain ID's to wells in dat2 according to plate diagram (stored in lab notebook)
for(i in 1:nrow(dat2)){
  if(dat2[i,2] == "A1" | dat2[i,2] == "A2" | dat2[i,2] == "A3" | dat2[i,2] == "A4" | dat2[i,2] == "A5" | dat2[i,2] == "D8" | dat2[i,2] == "D9" | dat2[i,2] == "D10" | dat2[i,2] == "D11" | dat2[i,2] == "D12" | dat2[i,2] == "G1" | dat2[i,2] == "G2"| dat2[i,2] == "G3"| dat2[i,2] == "G4"| dat2[i,2] == "G5"){
    dat2[i,4] <- "strain_2214"
  }
  if(dat2[i,2] == "D1" | dat2[i,2] == "D2" | dat2[i,2] == "D3" | dat2[i,2] == "D4" | dat2[i,2] == "D5" | dat2[i,2] == "A8" | dat2[i,2] == "A9" | dat2[i,2] == "A10" | dat2[i,2] == "A11" | dat2[i,2] == "A12" | dat2[i,2] == "H1" | dat2[i,2] == "H2" | dat2[i,2] == "H3" | dat2[i,2] == "H4" | dat2[i,2] == "H5") {
    dat2[i,4] <- "strain_2342"
  }
  if(dat2[i,2] == "C1" | dat2[i,2] == "C2" | dat2[i,2] == "C3" | dat2[i,2] == "C4" | dat2[i,2] == "C5" | dat2[i,2] == "F1" | dat2[i,2] == "F2" | dat2[i,2] == "F3" | dat2[i,2] == "F4" | dat2[i,2] == "F5" | dat2[i,2] == "H8" | dat2[i,2] == "H9"| dat2[i,2] == "H10" | dat2[i,2] == "H11" | dat2[i,2] == "H12") {
    dat2[i,4] <- "strain_14479"
  }
  if(dat2[i,2] == "E1" | dat2[i,2] == "E2" | dat2[i,2] == "E3" | dat2[i,2] == "E4" | dat2[i,2] == "E5" | dat2[i,2] == "C8" | dat2[i,2] == "C9" | dat2[i,2] == "C10" | dat2[i,2] == "C11" | dat2[i,2] == "C12" | dat2[i,2] == "G8" | dat2[i,2] == "G9"| dat2[i,2] == "G10"| dat2[i,2] == "G11"| dat2[i,2] == "G12"){
    dat2[i,4] <- "strain_2336"
  }
  if(dat2[i,2] == "A6" | dat2[i,2] == "B6" | dat2[i,2] == "C6" | dat2[i,2] == "D6" | dat2[i,2] == "E6" | dat2[i,2] == "B8" | dat2[i,2] == "B9" | dat2[i,2] == "B10" | dat2[i,2] == "B11" | dat2[i,2] == "B12") {
    dat2[i,4] <- "strain_2220"
  }
  if(dat2[i,2] == "B1" | dat2[i,2] == "B2" | dat2[i,2] == "B3" | dat2[i,2] == "B4" | dat2[i,2] == "B5" | dat2[i,2] == "A7" | dat2[i,2] == "B7" | dat2[i,2] == "C7" | dat2[i,2] == "D7" | dat2[i,2] == "E7" | dat2[i,2] == "F8" | dat2[i,2] == "F9"| dat2[i,2] == "F10"| dat2[i,2] == "F11"| dat2[i,2] == "F12") {
    dat2[i,4] <- "strain_4386"
  }
  if(dat2[i,2] == "E8" | dat2[i,2] == "E9" | dat2[i,2] == "E10" | dat2[i,2] == "E11" | dat2[i,2] == "E12") {
    dat2[i,4] <- "uninoculated"
  }
  if(dat2[i,2] == "F6" | dat2[i,2] == "F7" | dat2[i,2] == "G6" | dat2[i,2] == "G7" | dat2[i,2] == "H6" | dat2[i,2] == "H7") {
    dat2[i,4] <- "blank"
  }
}
...
endsWith(dat2[968,2], "11")

## Assign dicamba concentrations to wells in dat2 according to plate diagram
for(i in 1: nrow(dat2)){
  if(endsWith(dat2[i,2], "1")){
    dat2[i,5] <- 0.00
  }
  if(endsWith(dat2[i,2], "2")){
    dat2[i,5] <- 0.25
  }
  if(endsWith(dat2[i,2], "3")){
    dat2[i,5] <- 0.50
   }
  if(endsWith(dat2[i,2], "4")){
    dat2[i,5] <- 1.00
   }
  if(endsWith(dat2[i,2], "5")){
    dat2[i,5] <- 2.00
   }
  if(endsWith(dat2[i,2], "8")){
    dat2[i,5] <- 0.00
    }
  if(endsWith(dat2[i,2], "9")){
    dat2[i,5] <- 0.25
    }
  if(endsWith(dat2[i,2], "10")){
    dat2[i,5] <- 0.50
    }
  if(endsWith(dat2[i,2], "11")){
    dat2[i,5] <- 1.00
    }
  if(endsWith(dat2[i,2], "12")){
    dat2[i,5] <- 2.00
  }
  if(dat2[i,2] == "A6" | dat2[i,2] == "A7"){
    dat2[i,5] <- 0.00
  }
  if(dat2[i,2] == "B6" | dat2[i,2] == "B7"){
    dat2[i,5] <- 0.25
  }
  if(dat2[i,2] == "C6" | dat2[i,2] == "C7"){
    dat2[i,5] <- 0.50
  }
  if(dat2[i,2] == "D6" | dat2[i,2] == "D7"){
    dat2[i,5] <- 1.00
  }
  if(dat2[i,2] == "E6" | dat2[i,2] == "E7"){
    dat2[i,5] <- 2.00
  }
  if(dat2[i,2] == "E9") {
    dat2[i,5] <- 0.25
...
## Plot OD600 over time (growth curves) by dicamba concentration for each strain

tol1_gc_dat <- dat2
tol1_gc_dat$dicamba_concentration <- as.factor(tol1_gc_dat$dicamba_concentration) # make sure dicamba_concentration is a factor, otherwise r will treat it as a continuous numeric variable

sum_dat <- summarySE(tol1_gc_dat, measurevar = "OD600", groupvars = c("strain", "dicamba_concentration", "Hours"))

ggplot(sum_dat, aes(x = Hours, y = OD600, color = dicamba_concentration)) +
  geom_point() +
  geom_line() +
  geom_errorbar(aes(ymin = OD600-se, ymax = OD600+se)) +
  facet_wrap(~ strain, ncol = 2) +
  theme_bw() +
  theme(text = element_text(size = 18)) +
  scale_color_discrete(name = "Dicamba (g/L)") +
  labs(title = "Tolerance Screening 11/18/22")

# Plot without blank or uninoculated wells
sum_dat2 <- sum_dat %>%
  filter(strain != "blank", strain != "uninoculated")

ggplot(sum_dat2, aes(x = Hours, y = OD600, color = dicamba_concentration)) +
  geom_point() +
  geom_line() +
  geom_errorbar(aes(ymin = OD600-se, ymax = OD600+se)) +
  facet_wrap(~ strain, ncol = 2) +
...
## Calculate growth rates (r) across wells with package growthcurver
dat3 <- dat %>%
  rename("Time" = "Hours")
tol1_gc_fit <- SummarizeGrowthByPlate(dat3)
tol1_gc_fit <- as.data.frame(tol1_gc_fit)

tol1_gc_fit$vals
head(tol1_gc_fit)

sum_dat2 <- summarySE(tol1_gc_dat, measurevar = "OD600", groupvars = c("strain", "dicamba_concentration", "Well_ID"))
sum_dat2 <- sum_dat2[, 1:3]
tol1_gc_fit <- tol1_gc_fit %>%
  rename("Well_ID" = "sample")

tol1_gc_fit2 <- merge(tol1_gc_fit,sum_dat2, by = "Well_ID")

tol1_gc_fit2 <- tol1_gc_fit2 %>%
  filter(strain != "blank", strain != "uninoculated") %>%
  filter(Well_ID != "D11") # remove well D11 because lab notes indicate that this well was double dosed with dicamba during set-up

# Visualize r vs dicamba conc
tol1_gc_fit2 %>%
  ggplot(aes(dicamba_concentration, r)) + 
  geom_point() +
  geom_smooth() +
  facet_wrap(~ strain) + 
  theme_bw()

tol1_gc_fit2$plate_num <- 1

### Plate 2
dat1 <- read.csv("HERS2022_TolScreen2_Data_01-05-23.csv") # load data from second 96 well-plate
...
for(i in 1:97){
  for(j in 2:97){
   dat[i,j] <- dat1[i,j] - rowMeans(dat1[i, c(62:63, 73:75, 84:85)])
   j <- j + 1
  }
  i <- i + 1
}
...
## Assign strain ID's to wells in dat2 according to plate diagram (see lab notebook entry 12/14/22 and 12/17/22)
for(i in 1:nrow(dat2)){
  if(dat2[i,2] == "A1" | dat2[i,2] == "A2" | dat2[i,2] == "A3" | dat2[i,2] == "A4" | dat2[i,2] == "A5" | dat2[i,2] == "D8" | dat2[i,2] == "D9" | dat2[i,2] == "D10" | dat2[i,2] == "D11" | dat2[i,2] == "D12" | dat2[i,2] == "G1" | dat2[i,2] == "G2"| dat2[i,2] == "G3"| dat2[i,2] == "H4"| dat2[i,2] == "H5"){
    dat2[i,4] <- "strain_2063"
  }
  if(dat2[i,2] == "D1" | dat2[i,2] == "D2" | dat2[i,2] == "D3" | dat2[i,2] == "D4" | dat2[i,2] == "D5" | dat2[i,2] == "B8" | dat2[i,2] == "B9" | dat2[i,2] == "B10" | dat2[i,2] == "B11" | dat2[i,2] == "B12" | dat2[i,2] == "H1" | dat2[i,2] == "H2" | dat2[i,2] == "H3" | dat2[i,2] == "G4" | dat2[i,2] == "G5") {
    dat2[i,4] <- "strain_2217"
  }
  if(dat2[i,2] == "C1" | dat2[i,2] == "C2" | dat2[i,2] == "C3" | dat2[i,2] == "C4" | dat2[i,2] == "C5" | dat2[i,2] == "E8" | dat2[i,2] == "E9" | dat2[i,2] == "E10" | dat2[i,2] == "E11" | dat2[i,2] == "E12" | dat2[i,2] == "H8" | dat2[i,2] == "H9"| dat2[i,2] == "H10" | dat2[i,2] == "H11" | dat2[i,2] == "H12") {
    dat2[i,4] <- "strain_2145"
  }
  if(dat2[i,2] == "E1" | dat2[i,2] == "E2" | dat2[i,2] == "E3" | dat2[i,2] == "E4" | dat2[i,2] == "E5" | dat2[i,2] == "C8" | dat2[i,2] == "C9" | dat2[i,2] == "C10" | dat2[i,2] == "C11" | dat2[i,2] == "C12" | dat2[i,2] == "G8" | dat2[i,2] == "G9"| dat2[i,2] == "G10"| dat2[i,2] == "G11"| dat2[i,2] == "G12"){
    dat2[i,4] <- "strain_2316"
  }
  if(dat2[i,2] == "A6" | dat2[i,2] == "B6" | dat2[i,2] == "C6" | dat2[i,2] == "D6" | dat2[i,2] == "E6" | dat2[i,2] == "A8" | dat2[i,2] == "A9" | dat2[i,2] == "A10" | dat2[i,2] == "A11" | dat2[i,2] == "A12" | dat2[i,2] == "F1" | dat2[i,2] == "F2" | dat2[i,2] == "F3" | dat2[i,2] == "F4" | dat2[i,2] == "F5") {
    dat2[i,4] <- "strain_2480"
  }
  if(dat2[i,2] == "B1" | dat2[i,2] == "B2" | dat2[i,2] == "B3" | dat2[i,2] == "B4" | dat2[i,2] == "B5" | dat2[i,2] == "A7" | dat2[i,2] == "B7" | dat2[i,2] == "C7" | dat2[i,2] == "D7" | dat2[i,2] == "E7" | dat2[i,2] == "F8" | dat2[i,2] == "F9"| dat2[i,2] == "F10"| dat2[i,2] == "F11"| dat2[i,2] == "F12") {
    dat2[i,4] <- "strain_2087"
  }
  if(dat2[i,2] == "F6" | dat2[i,2] == "G6" | dat2[i,2] == "H6" | dat2[i,2] == "H7" |dat2[i,2] == "F7" | dat2[i,2] == "G7" | dat2[i,2] == "G8") {
    dat2[i,4] <- "uninoculated"
  }
}
...
tol2_gc_dat <- tol2_dat
tol2_gc_dat$dicamba_concentration <- as.factor(tol2_gc_dat$dicamba_concentration) # make sure dicamba_concentration is a factor, otherwise r will treat it as a continuous numeric variable
tol2_gc_sum_dat <- summarySE(tol2_gc_dat, measurevar = "OD600", groupvars = c("strain", "dicamba_concentration", "Hours"))

ggplot(tol2_gc_sum_dat, aes(x = Hours, y = OD600, color = dicamba_concentration)) +
  geom_point() +
  geom_line() +
  geom_errorbar(aes(ymin = OD600-se, ymax = OD600+se)) +
  facet_wrap(~ strain, ncol = 2) +
  ...
  theme(text = element_text(size = 18)) +
  scale_color_discrete(name = "Dicamba (g/L)") +
  labs(title = "Tolerance Screening 2 (plate 12/17/22)")

# Plot without blank/uninoculated
tol2_gc_sum_dat2 <- tol2_gc_sum_dat %>%
  filter(strain != "uninoculated")
ggplot(tol2_gc_sum_dat2, aes(x = Hours, y = OD600, color = dicamba_concentration)) +
  geom_point() +
  geom_line() +
  geom_errorbar(aes(ymin = OD600-se, ymax = OD600+se)) +
  facet_wrap(~ strain, ncol = 2) +
...
dat3 <- dat %>%
  rename("Time" = "Hours")
tol2_gc_fit <- SummarizeGrowthByPlate(dat3)
colnames(tol2_gc_fit)[1] = "Well_ID"

tol2_gc_sum_dat2 <- summarySE(tol2_gc_dat, measurevar = "OD600", groupvars = c("strain", "dicamba_concentration", "Well_ID"))
tol2_gc_sum_dat2 <- tol2_gc_sum_dat2[,1:3]

tol2_gc_dat2 <- merge(tol2_gc_fit, tol2_gc_sum_dat2, by = "Well_ID")
tol2_gc_dat2$plate_num <- 2

tol2_gc_dat2 <- tol2_gc_dat2 %>%
  filter(strain != "uninoculated")
...
### Plate 3
dat1 <- read.csv("HERS2022_TolScreen3_Data_01-05-23.csv") # load data from third 96 well-plate
dat <- data.frame(matrix(NA,    # Create empty data frame
                          nrow = 97,
                          ncol = 97))
...
for(i in 1:97){
  for(j in 2:97){
   dat[i,j] <- dat1[i,j] - rowMeans(dat1[i, c(44,62:65, 67, 93:97)])
   j <- j + 1
  }
  i <- i + 1
}

## Assign strain ID's to wells in dat2 according to plate diagram (see lab notebook entry 12/19/22)
...
for(i in 1:nrow(dat2)){
  if(dat2[i,2] == "A1" | dat2[i,2] == "A2" | dat2[i,2] == "A3" | dat2[i,2] == "A4" | dat2[i,2] == "A5" | dat2[i,2] == "D8" | dat2[i,2] == "D9" | dat2[i,2] == "D10" | dat2[i,2] == "D11" | dat2[i,2] == "D12" | dat2[i,2] == "G1" | dat2[i,2] == "G2"| dat2[i,2] == "G3"| dat2[i,2] == "G4"| dat2[i,2] == "G5"){
    dat2[i,4] <- "strain_2237"
  }
  if(dat2[i,2] == "D1" | dat2[i,2] == "D2" | dat2[i,2] == "D3" | dat2[i,2] == "D4" | dat2[i,2] == "D5" | dat2[i,2] == "B8" | dat2[i,2] == "B9" | dat2[i,2] == "B10" | dat2[i,2] == "B11" | dat2[i,2] == "B12" | dat2[i,2] == "H1" | dat2[i,2] == "H2" | dat2[i,2] == "H3" | dat2[i,2] == "H4" | dat2[i,2] == "H5") {
    dat2[i,4] <- "strain_2046"
  }
  if(dat2[i,2] == "C1" | dat2[i,2] == "C2" | dat2[i,2] == "C3" | dat2[i,2] == "C4" | dat2[i,2] == "C5" | dat2[i,2] == "E8" | dat2[i,2] == "E9" | dat2[i,2] == "E10" | dat2[i,2] == "E11" | dat2[i,2] == "E12") {
    dat2[i,4] <- "strain_2337"
  }
  if(dat2[i,2] == "E1" | dat2[i,2] == "E2" | dat2[i,2] == "E3" | dat2[i,2] == "E4" | dat2[i,2] == "E5" | dat2[i,2] == "C8" | dat2[i,2] == "C9" | dat2[i,2] == "C10" | dat2[i,2] == "C11" | dat2[i,2] == "C12" | dat2[i,2] == "F7" | dat2[i,2] == "G6"| dat2[i,2] == "H6"| dat2[i,2] == "G7"| dat2[i,2] == "H7"){
    dat2[i,4] <- "strain_2061"
  }
  if(dat2[i,2] == "A6" | dat2[i,2] == "B6" | dat2[i,2] == "C6" | dat2[i,2] == "D6" | dat2[i,2] == "E6" | dat2[i,2] == "A8" | dat2[i,2] == "A9" | dat2[i,2] == "A10" | dat2[i,2] == "A11" | dat2[i,2] == "A12" | dat2[i,2] == "G8" | dat2[i,2] == "G9" | dat2[i,2] == "G10" | dat2[i,2] == "G11" | dat2[i,2] == "G12") {
    dat2[i,4] <- "strain_2213"
  }
  if(dat2[i,2] == "B1" | dat2[i,2] == "B2" | dat2[i,2] == "B3" | dat2[i,2] == "B4" | dat2[i,2] == "B5" | dat2[i,2] == "A7" | dat2[i,2] == "B7" | dat2[i,2] == "C7"| dat2[i,2] == "E7" | dat2[i,2] == "F8" | dat2[i,2] == "F9"| dat2[i,2] == "F10"| dat2[i,2] == "F11"| dat2[i,2] == "F12" | dat2[i,2] == "F5") {
    dat2[i,4] <- "strain_2141"
  }
  if(dat2[i,2] == "H8" | dat2[i,2] == "H9"| dat2[i,2] == "H10" | dat2[i,2] == "H11" | dat2[i,2] == "H12" | dat2[i,2] == "F1" | dat2[i,2] == "F2" | dat2[i,2] == "F3" | dat2[i,2] == "F4" |dat2[i,2] == "F6" | dat2[i,2] == "D7") {
    dat2[i,4] <- "uninoculated"
  }
}
...
for(i in 1: nrow(dat2)){
  ...
  if(dat2[i,2] == "A6" | dat2[i,2] == "C7"){
    dat2[i,5] <- 0.50
  }
  if(dat2[i,2] == "B6" | dat2[i,2] == "A7"){
    dat2[i,5] <- 2.00
  }
  if(dat2[i,2] == "C6" | dat2[i,2] == "E7"){
    dat2[i,5] <- 0.00
  }
  if(dat2[i,2] == "D6" | dat2[i,2] == "B7"){
    dat2[i,5] <- 1.00
  }
  if(dat2[i,2] == "E6" | dat2[i,2] == "D7"){
    dat2[i,5] <- 0.25
  }
  if(dat2[i,2] == "F6" | dat2[i,2] == "F7") {
    dat2[i,5] <- 0.00
...
tol3_gc_dat <- tol3_dat
tol3_gc_dat$dicamba_concentration <- as.factor(tol3_gc_dat$dicamba_concentration) # make sure dicamba_concentration is a factor, otherwise r will treat it as a continuous numeric variable
tol3_gc_sum_dat <- summarySE(tol3_gc_dat, measurevar = "OD600", groupvars = c("strain", "dicamba_concentration", "Hours"))

ggplot(tol3_gc_sum_dat, aes(x = Hours, y = OD600, color = dicamba_concentration)) +
  geom_point() +
  geom_line() +
  geom_errorbar(aes(ymin = OD600-se, ymax = OD600+se)) +
  facet_wrap(~ strain, ncol = 2) +
  ...
  theme(text = element_text(size = 18)) +
  scale_color_discrete(name = "Dicamba (g/L)") +
  labs(title = "Tolerance Screening 3 (plate 12/19/22)")

## Plot without uninoculated wells
tol3_gc_sum_dat2 <-tol3_gc_sum_dat %>%
  filter(strain != "uninoculated")

ggplot(tol3_gc_sum_dat2, aes(x = Hours, y = OD600, color = dicamba_concentration)) +
  geom_point() +
  geom_line() +
  geom_errorbar(aes(ymin = OD600-se, ymax = OD600+se)) +
  facet_wrap(~ strain, ncol = 2) +
...
tol3_gc_fit <- SummarizeGrowthByPlate(dat)
colnames(tol3_gc_fit)[1] = "Well_ID"

tol3_gc_sum_dat3 <- summarySE(data = tol3_dat, measurevar = "OD600", groupvars = c("Well_ID", "strain", "dicamba_concentration"))

tol3_gc_fit2 <- merge(tol3_gc_fit,tol3_gc_sum_dat3, by = "Well_ID")
tol3_gc_dat2$plate_num <- 3

tol3_gc_fit2 <- tol3_gc_fit2 %>%
  filter(strain != "uninoculated")
...
tol3_gc_fit2 <- tol3_gc_fit2[,1:12]
tol3_gc_fit2$plate_num <- 3

### Calculate ED50's of all strains from results of all three plates
all_r_dat <- rbind(tol1_gc_fit2, tol2_gc_dat2, tol3_gc_fit2)

## Convert growth rate responses into percent of control responses

control_r_dat <- all_r_dat %>%
  filter(dicamba_concentration == 0)

control_r_dat_all_strains <- summarySE(control_r_dat, measurevar = "r", groupvars = "strain")
control_r_dat_all_strains #shows mean control growth rate values per strain, use this output to carry out calculations in for loop for generating %control responses below

ed50_r_dat <- all_r_dat
ed50_r_dat$r_percent_response <- 0
class(ed50_r_dat$r)

for(i in 1:nrow(ed50_r_dat)){
  if(ed50_r_dat[i,11] == "strain_14479"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1265875*100
  }
  if(ed50_r_dat[i,11] == "strain_2046"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1580684*100
  }
  if(ed50_r_dat[i,11] == "strain_2061"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1387898*100
  }
  if(ed50_r_dat[i,11] == "strain_2087"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1365328*100
  }
  if(ed50_r_dat[i,11] == "strain_2141"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.6933916*100
  }
  if(ed50_r_dat[i,11] == "strain_2145"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1342304*100
  }
  if(ed50_r_dat[i,11] == "strain_2213"){
   ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.2197052*100
  }
  if(ed50_r_dat[i,11] == "strain_2214"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1546576*100
  }
  if(ed50_r_dat[i,11] == "strain_2217"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.3130156*100
  }
  if(ed50_r_dat[i,11] == "strain_2220"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1032127*100
   }
  if(ed50_r_dat[i,11] == "strain_2237"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1635164*100
  }
  if(ed50_r_dat[i,11] == "strain_2316"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1608700*100
   }
  if(ed50_r_dat[i,11] == "strain_2336"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1150307*100
  }
  if(ed50_r_dat[i,11] == "strain_2337"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1659666*100
  }
  if(ed50_r_dat[i,11] == "strain_2342"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1126578*100
  }
  if(ed50_r_dat[i,11] == "strain_2480"){
   ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.2020772*100
  }
 if(ed50_r_dat[i,11] == "strain_4386"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1589140*100
 }
  if(ed50_r_dat[i,11] == "strain_2063"){
    ed50_r_dat[i,14] <- ed50_r_dat[i,4]/0.1648289*100
  }
  i < i + 1
}

## Plot dose response curve of growth rates

all_drc_sum_r_dat <- summarySE(ed50_r_dat, measurevar = "r_percent_response", groupvars = c("strain", "dicamba_concentration"))

c18 <- c(
  "#E31A1C", "dodgerblue2", # E31A1C = red
  "green4",
  "#6A3D9A", # purple
  "skyblue2", "gold1", "orange", "black", #orange
  "#FB9A99", # lt pink
  "palegreen2",
  "#CAB2D6", # lt purple
  "tan4", # lt orange
...
ggplot(all_drc_sum_r_dat, aes(x = dicamba_concentration, y = r_percent_response, color =  strain)) + 
  geom_point(position = position_dodge(width = 0.2), size = 2) +
  geom_errorbar(aes(ymax = r_percent_response+se, ymin = r_percent_response-se, width=0), position = position_dodge(width = 0.2), size = 0.75) +
  geom_line(aes(group = strain), position = position_dodge(width = 0.2), size = 1) +
  theme_classic() +
  labs(y = "% of control (growth rate)", x = "Dicamba concentration (g/L)") +
  theme(axis.title = element_text(size = 24), axis.text = element_text(size = 22), legend.title = element_text(size = 24), legend.text = element_text(size = 22)) +
  scale_color_manual(values = c18)

## Plot dose response curve of just 8 strains in microcosm experiment
drc_sum_r_dat_subset <- all_drc_sum_r_dat %>%
  filter(strain == "strain_14479"| strain == "strain_2063"| strain == "strain_2214" | strain == "strain_2141" | strain == "strain_2220" | strain == "strain_2316" | strain == "strain_4386" | strain == "strain_2087")

c8 <- c("#40B0A6", "#f0e442", "skyblue1", "black", "#cc79a9", "#785ef0", "#d55e00", "darkgoldenrod2")

ggplot(drc_sum_r_dat_subset, aes(x = dicamba_concentration, y = r_percent_response, color =  strain)) + 
  geom_point(position = position_dodge(width = 0.2), size = 2) +
  geom_errorbar(aes(ymax = r_percent_response+se, ymin = r_percent_response-se, width=0), position = position_dodge(width = 0.2), size = 0.75) +
  geom_line(aes(group = strain), position = position_dodge(width = 0.2), size = 1) +
  theme_classic() +
...
## Perform ED50 calculations of strains in microcosm experiment from dose-response modeling
class(ed50_r_dat$dicamba_concentration) #dicamba_con has to be numeric for drm model to run

ed50_r_dat2 <- ed50_r_dat %>%
  filter(strain == "strain_2141"| strain == "strain_2214" | strain == "strain_4386" | strain == "strain_14479" | strain == "strain_2063" | strain == "strain_2087" | strain == "strain_2220" | strain == "strain_2316") 

r_model <- drm(r_percent_response~dicamba_concentration, data=ed50_r_dat2, strain,
                  fct=LL.4(fixed = c(NA, 40, NA, NA),names = c("Slope", "Lower Limit", "Upper Limit", "ED50")))
plot(r_model3)
summary(r_model3) #setting lower limit to 40 results in small resid standard error and no NaNs produced

plot(r_model) # visualize results of dose-response model approximations across strains

ED(r_model,respLev = c(50), type = "absolute", interval = "delta") # reports ED50s for each strain
final_rhizobial_ED50_dat <- as.data.frame(ED(r_model,respLev = c(50), type = "absolute", interval = "delta"))
final_rhizobial_ED50_dat$strain <- c("14479", "2063", "2087", "2141", "2214", "2220", "2316", "4386")
final_rhizobial_ED50_dat$std_error <- final_rhizobial_ED50_dat$`Std. Error`

## Plot rhizobial ED50s
ggplot(final_rhizobial_ED50_dat, aes(y = Estimate, x = strain, color = strain)) +
  geom_point(size=3, aes(reorder(strain, Estimate))) + #order points by smallest to largest ED50
  geom_errorbar(aes(ymax = Estimate + std_error, ymin = Estimate - std_error, width=0)) + 
  ylab("Dicamba ED50 (g/L)") +
  xlab("Rhizobial strain") +
  theme_classic() +
...
## Add rhizobial ED50 to data frame
nod_in_dat$rhizobial_ED50 <- 0.00

for(i in 1:nrow(nod_in_dat)){
  if(nod_in_dat[i,3] == "strain_14479"){
    nod_in_dat[i,19] <- 4.47
  }
  if(nod_in_dat[i,3] == "strain_2063"){
    nod_in_dat[i,19] <- 2.41
  }
  if(nod_in_dat[i,3] == "strain_2087"){
    nod_in_dat[i,19] <- 1.90
  }
  if(nod_in_dat[i,3] == "strain_2141"){
    nod_in_dat[i,19] <- 5.03
    }
  if(nod_in_dat[i,3] == "strain_2214"){
    nod_in_dat[i,19] <- 3.82
  }
  if(nod_in_dat[i,3] == "strain_2220"){
    nod_in_dat[i,19] <- 2.27
  }
  if(nod_in_dat[i,3] == "strain_2316"){
    nod_in_dat[i,19] <- 1.15
  }
  if(nod_in_dat[i,3] == "strain_4386"){
    nod_in_dat[i,19] <- 2.12
  }
  i <- i + 1
}
...
nod_in_coxme5 <- coxme(Surv(first_nodule_timing, censored) ~ dicamba_trt*rhizobial_ED50 + dicamba_trt*plant_genotype + (1|Tray) + temporal_block, data = nod_in_dat) 
AIC(nod_in_coxme5) #2761.7

nod_in_models_all <- list(nod_in_coxme1, nod_in_coxme2, nod_in_coxme3, nod_in_coxme4, nod_in_coxme5)
aictab(nod_in_models_all)

### Model validation
summary(nod_in_coxme4)
test.ph <- cox.zph(nod_in_coxme4)
test.ph # the test is not statistically sig for each of the covariates, and global test is also not statistically significant, thus we can asssume the proportional hazards. The proportional hazards assumption is the assumption that the survival curves for two or more strata (i.e. factors) must have hazard functions that are proportional over time.
...
print(nod_in_fit, print.rmean=TRUE) # mean and se's of timing of nodulation of each dicamba trt; reported in Supplementary Table S2
...
print(nod_in_fit2, print.rmean=TRUE) # mean and se's of timing of nodulation of each strain; reported in Supplementary Table S2
...
## Add rhizobial ED50 to nod_num_dat
nod_num_dat$rhizobial_ED50 <- 0.00

for(i in 1:nrow(nod_num_dat)){
  if(nod_num_dat[i,3] == "strain_14479"){
    nod_num_dat[i,15] <- 4.47
  }
  if(nod_num_dat[i,3] == "strain_2063"){
    nod_num_dat[i,15] <- 2.41
  }
  if(nod_num_dat[i,3] == "strain_2087"){
    nod_num_dat[i,15] <- 1.90
  }
  if(nod_num_dat[i,3] == "strain_2141"){
    nod_num_dat[i,15] <- 5.03
    }
  if(nod_num_dat[i,3] == "strain_2214"){
    nod_num_dat[i,15] <- 3.82
  }
  if(nod_num_dat[i,3] == "strain_2220"){
    nod_num_dat[i,15] <- 2.27
  }
  if(nod_num_dat[i,3] == "strain_2316"){
    nod_num_dat[i,15] <- 1.15
  }
  if(nod_num_dat[i,3] == "strain_4386"){
    nod_num_dat[i,15] <- 2.12
  }
  i <- i + 1
}
...
class(nod_num_dat$rhizobial_ED50) # numeric
...
nod_num_lmer_mod5 <- lmer(log(WK4_num_nodules) ~ dicamba_trt*plant_genotype + dicamba_trt*rhizobial_ED50 + rhizobial_ED50*plant_genotype + (1|Tray) + WK4_fungal_pathogen_minor + temporal_block, data = nod_num_dat, REML = FALSE)
AIC(nod_num_lmer_mod5) #548.8

nod_num_models_all <- list(nod_num_lmer_mod1, nod_num_lmer_mod2, nod_num_lmer_mod3, nod_num_lmer_mod4, nod_num_lmer_mod5)
...
## Add rhizobial ED50 to N_data3
N_data3$rhizobial_ED50 <- 0.00

for(i in 1:nrow(N_data3)){
  if(N_data3[i,4] == "strain_14479"){
    N_data3[i,29] <- 4.47
  }
  if(N_data3[i,4] == "strain_2063"){
    N_data3[i,29] <- 2.41
  }
  if(N_data3[i,4] == "strain_2087"){
    N_data3[i,29] <- 1.90
  }
  if(N_data3[i,4] == "strain_2141"){
    N_data3[i,29] <- 5.03
    }
  if(N_data3[i,4] == "strain_2214"){
    N_data3[i,29] <- 3.82
  }
  if(N_data3[i,4] == "strain_2220"){
    N_data3[i,29] <- 2.27
  }
  if(N_data3[i,4] == "strain_2316"){
    N_data3[i,29] <- 1.15
  }
  if(N_data3[i,4] == "strain_4386"){
    N_data3[i,29] <- 2.12
  }
  i <- i + 1
}
...
N_model1 <- lmer(delta_15N ~ dicamba_trt*strain_ID*plant_genotype + (1|Tray) + WK4_fungal_pathogen_minor + rhizobial_ED50, data = N_data4, REML = FALSE)
AIC(N_model1) #565.0
...
N_model5 <- lmer(delta_15N ~ dicamba_trt*rhizobial_ED50 + dicamba_trt*plant_genotype + (1|Tray) + WK4_fungal_pathogen_minor, REML = FALSE, data = N_data4)
AIC(N_model5) #556.4

N_models_all <- list(N_model1, N_model2, N_model3, N_model4, N_model5)
aictab(N_models_all)

### Model Validation
simulationOutput <- simulateResiduals(fittedModel = N_model4, plot = F)
plot(simulationOutput) # passes
plot(histogram(residuals(N_model3))) # residuals are normally distributed
...
summary(N_emmeans, by = NULL, adjust = "dunnettx") # Dunnet p-value adjustments, these results are reported in Supplementary Table S3 (Part B)


### Visualize results

## Calculate estimated marginal means for foliar delta-15 N data from N_model4 (best model)

N_emmeans <- emmeans(N_model4, pairwise ~ dicamba_trt|strain_ID, type = "response", adjust = "Tukey")
...
## Add rhizobial dicamba tolerance variable (ED50 based on growth rate) to dataset
sb_dat$rhizobial_ED50 <- 0

for(i in 1:nrow(sb_dat)){
  if(sb_dat[i,3] == "strain_14479"){
    sb_dat[i,15] <- 4.47
  }
  if(sb_dat[i,3] == "strain_2063"){
    sb_dat[i,15] <- 2.41
  }
  if(sb_dat[i,3] == "strain_2087"){
    sb_dat[i,15] <- 1.90
  }
  if(sb_dat[i,3] == "strain_2141"){
    sb_dat[i,15] <- 5.03
    }
  if(sb_dat[i,3] == "strain_2214"){
    sb_dat[i,15] <- 3.82
  }
  if(sb_dat[i,3] == "strain_2220"){
    sb_dat[i,15] <- 2.27
  }
  if(sb_dat[i,3] == "strain_2316"){
    sb_dat[i,15] <- 1.15
  }
  if(sb_dat[i,3] == "strain_4386"){
    sb_dat[i,15] <- 2.12
  }
  i <- i + 1
}
...
sb_lmer_mod5 <- lmer(sqrt(shoot_biomass) ~ rhizobial_ED50*dicamba_trt + dicamba_trt*plant_genotype + (1|Tray), data = sb_dat, REML = FALSE)
AIC(sb_lmer_mod5) #230.3

sb_models_all <- list(sb_lmer_mod1, sb_lmer_mod2, sb_lmer_mod3, sb_lmer_mod4, sb_lmer_mod5)
...
for(j in 1:nrow(uninoc_dat)){
  for(i in 1:nrow(inoc_dat)){
    if(inoc_dat[i,2]==uninoc_dat[j,1] && inoc_dat[i,4]==uninoc_dat[j,3] && inoc_dat[i,5] == uninoc_dat[j,4]){
      inoc_dat[i,16] <- inoc_dat[i,9] - uninoc_dat[j,5]
      i <- i + 1
    }
    else{
      i <- i + 1
